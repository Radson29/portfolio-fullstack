    ...
    if (this.categories != null && this.categories.length > 0) {
      switch (this.categories[0]) {
        ...
        case StackCategory.FRONTEND:
          ngClass = "frontend";
          break;
        case StackCategory.IN_PROGRESS:
          ngClass = "game";
          break;
      }
    }
...
export class StackComponent {
  stacks: Stack[] = [
    ...
    new Stack('Thymeleaf','ThymeleafIcon.svg', [StackCategory.BACKEND]),
    new Stack('C#', 'csharp-svgrepo-com.svg', [StackCategory.IN_PROGRESS]),
    new Stack('Kotlin', 'kotlin-svgrepo-com.svg', [StackCategory.IN_PROGRESS]),
    new Stack('C++','c.svg', [StackCategory.IN_PROGRESS])
  ];
  tools: Stack[] = [
    ...
    new Stack('Gradle', 'gradle-svgrepo-com.svg', [StackCategory.BACKEND]),
    new Stack('Maven', 'maven-svgrepo-com.svg', [StackCategory.BACKEND])
  ]
